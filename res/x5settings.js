(function ( $, x5engine ) {
	...
	s.siteId = '1758C0865751F6075446A88B778435AB';
	s.version = '17-1-2-0';
	b.push(function () {
		x.setupDateTime();
	...
	b.push(function () {
		x.stickyBar({
			enabledBreakpoints: ['3935786e578cfb800f500e6819c93cba','5ecdcca63de80fd3d4fbb36295d22b7d']
		});
	});
	...
	// BreakPoints
	s.breakPoints.push({ "hash": "3935786e578cfb800f500e6819c93cba", "name": "Desktop", "start": "max", "end": 0, "fluid": false });
